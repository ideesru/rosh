    ...
    <div class="acount__table-main accardeon__main acount__table-auto">
        <div class="admin-events-item heap">
            ...
            <div class="flag-date">
                ...
                <span class="dt"><strong class="title">Событие: </strong><?=$created_date?> <br><?=$created_time?></span>
            </div>
        </div>
                        ...
                        <div class="row acount__photos-wrap mb-20">
                            <div class="col-md-6">
                                <div class="acount__photo">
                                    <p>Фото до начала лечения</p><img src="/www/img/experts/1.jpg" alt="">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="acount__photo">
                                    <p>Фото в процессе лечения</p><img src="/www/img/experts/1.jpg" alt="">
                                </div>
                            </div>
                        </div>
