<div class="popup --service-l">
    ...
    <div class="popup__panel">
        ...
        <div class="popup__img"><img src="/www/img/popup/1.jpg" alt=""></div>
        ...
        <div class="text">
            ...
            <p class="mb-10">Назначит дополнительное обследование, лечение, а также даст рекомендации по образу жизни.</p>
        </div><a class="btn btn--black" href="/landing">Читать подробнее</a>
    </div>
</div>
